...
<div style="height:5px"></div>
	...
	<div class="gt-right">			
			<div style="font-weight:bold;">				
				<a href="<?php echo esc_url( PLEASANT_LITE_LIVE_DEMO ); ?>" target="_blank"><?php _e('Live Demo', 'pleasant-lite'); ?></a> | 	
                <a href="<?php echo esc_url( PLEASANT_LITE_PROTHEME_URL ); ?>" target="_blank"><?php _e('Purchase Pro', 'pleasant-lite'); ?></a> | 			
				<a href="<?php echo esc_url( PLEASANT_LITE_THEME_DOC ); ?>" target="_blank"><?php _e('Documentation', 'pleasant-lite'); ?></a>
                <div style="height:5px"></div>
				<hr />  
                <ul>
